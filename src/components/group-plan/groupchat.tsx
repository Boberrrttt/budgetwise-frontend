    ...
    return (
        <div className="border w-full h-full flex flex-col border-black dark:border-white ">
            <div className="border-black dark:border-white border-b flex items-center h-12 px-2">
                ...
                <div className='w-7 h-[60%] bg-white rounded-full'>
                ...
                <AnimatePresence>
                        {isSettings && (
                            <motion.div
                                ...
                                className='h-full text-lg flex flex-col '
                            >
                                <div className='flex gap-5 items-center cursor-pointer hover:bg-gray-600 py-5 px-2 transition-colors duration-250 '>
                                ...
                                <div className='flex ml-1 gap-3 items-center cursor-pointer hover:bg-gray-600 py-5 px-2 transition-colors duration-250'>
